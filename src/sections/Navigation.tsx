    ...
    <>
      ...
      >
        <div className="flex items-center justify-between h-[80px] px-6 md:px-12 lg:px-20">
          <Link
            to="/"
            className="font-serif text-lg md:text-xl lg:text-2xl tracking-wide text-white leading-tight"
          >
            <span className="text-[#d4af37]">E</span>agle Executive Transport <span className="hidden sm:inline">& Security Inc</span>
          </Link>
